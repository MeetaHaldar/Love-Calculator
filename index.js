...
{
    document.querySelector("p").innerHTML="'"+ myInput1.value + " + "+ myInput2.value + "' "+(" ( You are falling in love ) = ") + randomNumber+"%";
    document.querySelector('img').src='https://thumbs.gfycat.com/EllipticalSnoopyCrocodile-size_restricted.gif';

}
else if(randomNumber>80)
{
    document.querySelector("p").innerHTML= "'" +myInput1.value + " + "+ myInput2.value+"' " + (" ( True love is there ) = ") + randomNumber+"%";
    document.querySelector('img').src='https://c.tenor.com/0aJdWy--KOcAAAAC/turulove-true-love.gif';

}
else{
    document.querySelector("p").innerHTML= "'"+ myInput1.value + " + "+ myInput2.value+"' " +(" ( Fake love!! ) = ") + randomNumber+"%";
